...
export default function SiteFooter() {
  return <footer>
    ...
    <div><strong>Resources</strong><Link href="/guide">Leader&apos;s guide</Link><Link href="/history">Camp history</Link><Link href="/map">Interactive map</Link><Link href="/alerts">Conditions & notices</Link><Link href="/pre-register">Pre-register</Link></div>
