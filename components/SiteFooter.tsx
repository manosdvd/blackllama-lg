...
export default function SiteFooter() {
  return <footer>
    <div className="footer-brand"><img src="/images/logo-ui.webp" alt="" width={96} height={96} className="brand-mark" /><div><strong>Camp Lawton</strong><small>Catalina Council · Arizona</small></div></div>
